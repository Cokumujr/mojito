...
const Menu = () => {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo(".details h3", { opacity: 0, yPercent: 100 },
            { opacity: 1, yPercent: 0, duration: 1, ease: 'power1.inOut', delay: 0.5 })
        gsap.fromTo(".details p", { opacity: 0, yPercent: 100 },
            { opacity: 1, yPercent: 0, duration: 1, ease: 'power1.inOut', delay: 0.7 })
    }, [currentIndex]);
